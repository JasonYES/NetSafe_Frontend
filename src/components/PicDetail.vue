     ...
     <Row type="flex" justify="center" class="nselect" style="margin-top:50px;">
        ...
        <Col span="12" style="">
                ...
                <Row type="flex"   justify="start"  style="margin-top:20pxl"  >
                    <Col span="12"> 
                        <Breadcrumb>
                            <Breadcrumb-item href="/picpage">上级菜单</Breadcrumb-item>
                ...
                <br />
                <br />
                <div v-for="item in JSON.parse(news.content)">
                    
                        <div  style="height:100%; margin:40px 0px 40px 0px" align="center">
                            <img :src="SRCparse(item)"  class="projectPic" style="width:80%;height:80%;">
                        </div>
        ...
        <Col span="6" class="nselect"  style="margin-left:20px;margin-top:72px;">
            ...
            <Row type="flex" justify="center"  align="bottom">
                <Col span="6" >  <p style="font-size:20px;font-family:'华文宋体';"> 相关内容</p>
                    ...
                    <Row >
                        ...
                        <Col span="20"  align="left">
                            <div  style="width:280px;overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">
                                <a class="content"  href="#" onclick="return false" @click="enterDetails(notice)" > <Icon type="arrow-right-b"></Icon>   &nbsp;&nbsp;{{notice.title}}</a> 
                            </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.$request({
                method: 'get',
                url: '/api/doc?role=1&project=['+this.project+']&isdoc=0',
                data: {}
              }).then((response) => {
